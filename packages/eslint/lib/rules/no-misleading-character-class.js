...
const { isCombiningCharacter, isEmojiModifier, isRegionalIndicatorSymbol, isSurrogatePair } = require("./utils/unicode/index.js");
const astUtils = require("./utils/ast-utils.js");
const { isValidWithUnicodeFlag } = require("./utils/regular-expressions.js");
...
/** @type {import('../shared/types.js').Rule} */
module.exports = {
    meta: {
        type: "problem",
